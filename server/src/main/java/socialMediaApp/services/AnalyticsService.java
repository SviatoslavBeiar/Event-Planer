...
import socialMediaApp.responses.PostAnalyticsResponse;
...
public class AnalyticsService {
    ...
    public PostAnalyticsResponse getPostTicketAnalytics(int postId, int days) {
        ...
        Long remaining = capacity == null ? null : Math.max(0, (long)capacity - ticketsSoldTotal);
        ...
        return new PostAnalyticsResponse(ticketsSoldTotal, capacity, remaining, revenue, salesByDay);
    }
